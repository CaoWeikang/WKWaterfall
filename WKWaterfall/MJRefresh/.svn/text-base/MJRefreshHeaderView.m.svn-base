...
@property (nonatomic, strong) UIImage *refreshImage; // 刷新图片
@end
...
- (UIImage *)refreshImage
{
    if (_refreshImage == nil) {
        _refreshImage = [UIImage imageNamed:@"refresh2"];
    }
...
{
    if (!_activityView) {
        UIImageView *animation = [[UIImageView alloc] initWithFrame:self.arrowImage.bounds];
        animation.center = self.arrowImage.center;
//        animation.animationDuration = 0.5;
        animation.autoresizingMask = UIViewAutoresizingNone;
//        animation.animationImages = @[[UIImage imageNamed:@"refresh1"],[UIImage imageNamed:@"refresh2"],[UIImage imageNamed:@"refresh3"],[UIImage imageNamed:@"refresh4"],[UIImage imageNamed:@"refresh5"],[UIImage imageNamed:@"refresh6"],[UIImage imageNamed:@"refresh7"],[UIImage imageNamed:@"refresh8"]];
...
{
    self.activityView.image = self.refreshImage;
    ...
    [self.activityView.layer addAnimation:animation forKey:@"keyFrameAnimation"];
}
@end